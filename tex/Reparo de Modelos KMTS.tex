...
\documentclass[bsc, std, a4paper]{ufbathesis}
...
\program{Trabalho de Conclusão de Curso}
...
\adviser[f]{Profa. Dra. Aline Andrade}
...
% Ficha catalográfica
\authorcitationname{Marques, Pedro Dumont} % e.g. Terceiro, Antonio Soares de Azevedo
\advisercitationname{Andrade, Aline} % e.g. Chavez, Christina von Flach Garcia
...
\catalogtopics{1. Métodos Formais. 2. Verificação de Modelos} % e.g. ``1. Complexidade Estrutural. 2. Engenharia de Software''
...
\chapter{Introdução}{Este é o primeiro capítulo, onde eu conto toda a
...
\chapter{Revisão Bibliográfica}{Neste capítulo eu apresento todo o
